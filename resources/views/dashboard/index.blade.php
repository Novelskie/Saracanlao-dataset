...
<div class="container py-5">
    <h1 class="mb-5 text-center fw-bold display-5 animate__animated animate__fadeInDown">Saracanlao Sales Report Dashboard</h1>
        ...
        <div class="col-md-4">
            <div class="card shadow border-0 rounded-4 animate__animated animate__zoomIn">
                <div class="card-body text-center p-4">
                    ...
                    <h2 class="fw-bold text-warning">₱{{ number_format($totalSales, 2) }}</h2>
                </div>
            </div>
        </div>
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach ($salesPerRegion as $region)
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span class="fw-bold text-info">{{ number_format($region['total_units']) }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
...
new Chart(salesPerRegionCtx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(41, 223, 95, 0.74)',
            borderColor: 'rgba(45, 223, 68, 0.79)',
            borderWidth: 1,
            borderRadius: 6,
        }]
    },
...
new Chart(salesPerMonthCtx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(59, 226, 81, 0.49)',
            borderColor: 'rgb(245, 210, 52)',
            pointBackgroundColor: 'rgb(240, 214, 66)',
            fill: true,
            tension: 0.4,
        }]
    },
